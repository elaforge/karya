...
module Solkattu.Dsl.KendangPasang (
    module Solkattu.Dsl.KendangPasang
    , module Dsl.Solkattu
...
type Stroke = Realize.Stroke KendangPasang.Stroke
...
KendangPasang.Strokes {..} = KendangPasang.notes
...
nakatiku :: Sequence
nakatiku = namedT Solkattu.GPattern "8n" KendangPasang.nakatiku
