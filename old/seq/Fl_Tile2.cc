...
void Fl_Tile2::position(int oix, int oiy, int newx, int newy) {
...
void Fl_Tile2::resize(int X,int Y,int W,int H) {
...
static void set_cursor(Fl_Tile2*t, Fl_Cursor c) {
