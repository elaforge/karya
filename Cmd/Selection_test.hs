...
test_time_scroll_with_selection = do
    let mksel start dur = Block.Selection 0 (TrackPos start) 1 (TrackPos dur)
    ...
    equal (f (mksel 2 4) (mksel 2 4) 2 6) (TrackPos 2)
    equal (f (mksel 2 4) (mksel 1 4) 2 6) (TrackPos 0)
    equal (f (mksel 2 4) (mksel 2 5) 2 6) (TrackPos 4)
    -- If both expand, don't go anywhere.
    equal (f (mksel 2 4) (mksel 1 6) 2 6) (TrackPos 2)

test_track_scroll_with_selection = do
    let mksel start tracks =
            Block.Selection start (TrackPos 0) tracks (TrackPos 0)
    ...
    -- Also works from the middle.
    equal (f (mksel 2 4) (mksel 2 4) 2 6) (TrackPos 2)
    equal (f (mksel 2 4) (mksel 1 4) 2 6) (TrackPos 1)
    equal (f (mksel 2 4) (mksel 0 4) 2 6) (TrackPos 0)
    equal (f (mksel 2 4) (mksel 2 5) 2 6) (TrackPos 3)
    equal (f (mksel 2 4) (mksel 2 6) 2 6) (TrackPos 4)
    -- Sensible even with out of range selection.
    equal (f (mksel 2 4) (mksel 2 7) 2 6) (TrackPos 4)

    equal (f (mksel 2 4) (mksel 2 5) 2.5 5.5) (TrackPos 4)
