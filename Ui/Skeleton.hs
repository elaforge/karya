...
to_forest :: Types.TrackNum -> Skeleton -> Tree.Forest Types.TrackNum
...
insert :: Types.TrackNum -> Skeleton -> Skeleton
...
remove :: Types.TrackNum -> Skeleton -> Skeleton
remove tracknum = map_skel (Graph.remove_vertex tracknum)

toggle_edge :: (Types.TrackNum, Types.TrackNum) -> Skeleton -> Maybe Skeleton
toggle_edge edge (Skeleton graph) = case Graph.toggle_edge edge graph of
    Nothing -> Nothing
    Just graph -> Just (Skeleton graph)

splice :: (Types.TrackNum, Types.TrackNum) -> Skeleton -> Skeleton
