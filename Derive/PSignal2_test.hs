...
module Derive.PSignal2_test where
...
import qualified Derive.PSignal2 as PSignal
...
test_apply_controls = do
    ...
    equal (f [(trans1, [(0, 1)])] [(0, 1), (1, 2), (2, 1)])
        [(0, Right 1), (0, Right 2), (1, Right 3), (2, Right 2)]
    ...
    equal (f [(trans1, [(0, 1), (1, 1), (1, 2)])] [(0, 1)])
        [(0, Right 1), (0, Right 2), (1, Right 2), (1, Right 3)]
