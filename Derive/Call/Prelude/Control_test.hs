...
module Derive.Call.Prelude.Control_test where
...
test_abs = do
    ...
    equal (run [("c", [(0, 0, ".5")]), ("set c", [(0, 0, "abs .75")])])
        ([[(0, 0.75)]], [])
    equal (run [("c", [(0, 0, ".5")]), ("add c", [(0, 0, "abs .75")])])
        ([[(0, 0.75)]], [])
    equal (run [("c", [(0, 0, ".5")]), ("sub c", [(0, 0, "abs .75")])])
        ([[(0, 0.75)]], [])
    equal (run [("c", [(0, 0, ".5")]), ("mul c", [(0, 0, "abs .75")])])
        ([[(0, 0.75)]], [])
    equal (run [("c", [(0, 0, ".5")]), ("scale c", [(0, 0, "abs .75")])])
        ([[(0, 0.75)]], [])
    equal (run [("c", [(0, 0, ".5")]), ("scale c", [(0, 0, "abs .25")])])
        ([[(0, 0.25)]], [])
...
test_up_down = do
    ...
    equal (run [(0, "from=1 | d .5")]) [(0, 1), (1, 0.5), (2, 0)]
    equal (run [(0, "from=.5 | d .25")]) [(0, 0.5), (1, 0.25), (2, 0)]
