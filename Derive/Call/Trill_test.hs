...
test_absolute_trill = do
    ...
    equal (transform (f (Signal.signal [(0, 1), (0.5, 2)]) (con 4)))
        [[(0, 60), (0.25, 61), (0.5, 60), (0.75, 62), (1, 60)]]
